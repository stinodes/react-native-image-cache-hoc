...
export default function imageCacheHoc(Image, options = {}) {
  ...
  return class extends React.PureComponent {
    ...
    async componentDidMount() {
      ...
      const fileName = await this.fileSystem.getFileNameFromUrl(url, this.props.headers);
    ...
    async _loadImage(url) {
      ...
      try {
        localFilePath = await this.fileSystem.getLocalFilePathFromUrl(url, permanent, this.props.headers);
      } catch (error) {
